...
![Follow the 5 steps provided by Microsoft to create your knowledge base bot]("Follow the 5 steps provided by Microsoft to create your knowledge base bot.png" "Follow the 5 steps provided by Microsoft to create your knowledge base bot")
...
![Create your new QnA Maker service by filling out the required fields]("Create your new QnA Maker service by filling out the required fields.png" "Create your new QnA Maker service by filling out the required fields")
...
![Select your Microsoft Azure account, subscription name, and the recently created QnA service]("Select your Microsoft Azure account, subscription name, and the recently created QnA service.png" "Select your Microsoft Azure account, subscription name, and the recently created QnA service")
...
![Populate your knowledge base with either a URL, document, or manually]("Populate your knowledge base with either a URL, document, or manually.png" "Populate your knowledge base with either a URL, document, or manually")
...
![Loading screen while your knowledge base is created]("Loading screen while your knowledge base is created.png" "Loading screen while your knowledge base is created")
...
![Your knowledge base is a generated list of key value pairs]("Your knowledge base is a generated list of key value pairs.png" "Your knowledge base is a generated list of key value pairs")
...
![Example of QnAMaker bot using an exact match]("Example of QnAMaker bot using an exact match.gif" "Example of QnAMaker bot using an exact match")

![Example of QnAMaker using a similar match]("Example of QnAMaker using a similar match.gif" "Example of QnAMaker using a similar match")

![Type in a message to determine if QnA Maker is working as you desire]("Type in a message to determine if QnA Maker is working as you desire.png" "Type in a message to determine if QnA Maker is working as you desire")
...
![You can inspect a response and make changes to both the expected answer and add an alternative quesiton]("You can inspect a response and make changes to both the expected answer and add an alternative quesiton.gif" "You can inspect a response and make changes to both the expected answer and add an alternative quesiton")
...
![You will need some information from the Sample HTTP request section on this page]("You will need some information from the Sample HTTP request section on this page.png" "You will need some information from the Sample HTTP request section on this page")
